...
class cfgVehicles
{
    ...
    class CGQC_Soldat_Moderne : B_Soldier_f
    {
        ...
        linkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "ItemGPS", "Rangefinder", "H_mas_can_Beret", "V_Rangemaster_belt"};
        respawnLinkedItems[] = {"ItemMap", "ItemCompass", "ItemWatch", "ItemGPS", "Rangefinder", "H_mas_can_Beret", "V_Rangemaster_belt"};
