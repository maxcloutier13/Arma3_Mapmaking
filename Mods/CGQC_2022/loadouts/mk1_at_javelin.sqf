...
_unit addWeapon "cgqc_gun_mk1_Javelin";
_unit addSecondaryWeaponItem "jav_AT_mas_can";
...
_unit addBackpack "CGQC_units_mk1_3_AT_Javelin_pack";
...
for "_i" from 1 to 2 do {
	_unit addItemToBackpack "jav_AT_mas_can";
};
...
[_unit, "AfricanHead_03", "male05eng"] call BIS_fnc_setIdentity;