class cfgGroups
{
    class WEST
    {
        ...
        class CGQC
        {
            ...
            {
                name = "Special Forces";
                class CGQC_B_Predateur_sniper_team
                {
                    name = "Predateur sniper team";
                    faction = "CGQC";
                    side = 1;
                    class Unit0
                    {
