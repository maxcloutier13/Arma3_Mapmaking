...
_source addAction ["Teleport: Weapons Range", "scripts\teleportation8.sqf", [], 1, false, true, "", "_this distance _target < 3"];
_source addAction ["Teleport: 9-hole Range", "scripts\teleportation9.sqf", [], 1, false, true, "", "_this distance _target < 3"];
