...
(findDisplay 46) displayAddEventHandler ["KeyDown", "if ((_this select 1) == 28) then {
	TrainingCourse_BulletCameraAbort = true;
};
"];
...
cutText ["Appuis sur 'Enter' pour sortir", "PLAIN DOWN"];
