...
CGQC_int_targetHit = {
    ...
    if (_hits isEqualTo cgqc_qualif_service_neededHits) then {
        ...
        cgqc_qualif_service_targets deleteAt 0;
...
CGQC_int_qualificationSave = {
    ...
    if (count _previousResult isEqualTo 0) then {
        ...
        _attempts = _previousResult select 5;
        _attempts = _attempts + 1;
        _previousResult set [5, _attempts];
        cgqc_qualif_newResult pushBack _attempts;
    ...
    _textDone = format ["
        <t size='4'>Qualification Practice</t><br/>
        <t size ='3'>Score:%1 - %2</t><br/>
        <t size ='3'>%3</t><br/>
        <t size ='2'>%4</t><br/>
...
CGQC_int_riflePrep = {
    ...
    cgqc_qualify_shootingPosition hideObjectGlobal false;
    ...
    qualification_shoot_event = cgqc_qualif_service_student addEventHandler ["fired", {
        ...
        hint format["Shot: %1", cgqc_qualif_service_totalShots];
...
CGQC_int_rifleDone = {
    ...
    hideObjectGlobal cgqc_qualify_shootingPosition;
    cgqc_qualif_running = false;
    cgqc_qualif_on = false;
};
