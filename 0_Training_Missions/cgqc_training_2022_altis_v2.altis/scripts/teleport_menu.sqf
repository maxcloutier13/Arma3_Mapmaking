...
//source addAction ["Teleport: Nimitz", "scripts\teleport.sqf", [tp_nimitz], 1, false, true, "", "_this distance _target < 3"]; 
...
_source addAction ["Teleport: Diving Training", "scripts\teleport.sqf", [tp_diving], 1, false, true, "", "_this distance _target < 3"];
Dostop _source;
