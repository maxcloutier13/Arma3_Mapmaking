// [player, false, false] execvm "ROS_GroupHalo\scripts\smoke-red.sqf";
...
_emitter setParticleParams [
	...
	[[0.3, 0.01, 0.01, 0.1], [0.3, 0.01, 0.01, 0.1], [0.3, 0.01, 0.01, 0.1], [0.3, 0.01, 0.01, 0.1], [0.3, 0.01, 0.01, 0.05], [0.3, 0.01, 0.01, 0.05]],
	[1], // anim spd
	1, // rand dir period
	0.1, // rand dir inten
	"", // on timer script
