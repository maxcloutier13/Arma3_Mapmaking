// [player, false, false] execvm "ROS_GroupHalo\scripts\smoke-blue.sqf";
...
_emitter setParticleParams [
	...
	0.15, // volume
	0.01, // rubbing
	[0.5,2,4], // size over lifetime
	// color during its life  RGBA
	[[0, 0.05, 0.4, 0.1], [0, 0.05, 0.4, 0.1], [0, 0.05, 0.4, 0.1], [0, 0.05, 0.4, 0.1], [0, 0.05, 0.4, 0.1], [0, 0.05, 0.4, 0.05]],
	[1], // anim spd
	1, // rand dir period
	0.1, // rand dir inten
	"", // on timer script
