class cfgPatches
{
  class MY_TAG_My_Faction
  {
    units[]={"MY_TAG_testguy"};
    weapons[]={"MY_TAG_hgun_P07_F"};
    requiredVersion=0.1;
...
class cfgWeapons
{
  ...
  class MY_TAG_hgun_P07_F: hgun_P07_F
  {
    displayName="P99";
    scope=1;
    class LinkedItems
...
class cfgVehicles
{
  ...
  class MY_TAG_testguy: B_Soldier_A_F
  {
    ...
    backpack="MY_TAG_testguy_pack";
  };


  class MY_TAG_testguy_pack: B_AssaultPack_rgr
  {
    scope=1;
    ...
    class TransportItems
    {
     ...
     class _xx_ACE_splint {count=1;name="ACE_splint";};
     class _xx_ACE_tourniquet {count=1;name="ACE_tourniquet";};
     class _xx_ACE_morphine {count=1;name="ACE_morphine";};
